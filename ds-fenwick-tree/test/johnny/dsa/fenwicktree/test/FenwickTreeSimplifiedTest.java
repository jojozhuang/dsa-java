...
import johnny.dsa.fenwicktree.FenwickTreeSimplified;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertEquals;

public class FenwickTreeSimplifiedTest {

    @Test
    public void testFenwickTreeSimplified() {
        System.out.println("testFenwickTreeSimplified");
        int[] nums = new int[]{2, -1, 6, 1, 5, -3, 4, 1, -2, 7};
        FenwickTreeSimplified instance = new FenwickTreeSimplified(nums);
